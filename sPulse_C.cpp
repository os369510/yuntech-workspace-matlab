...
#define S_FUNCTION_NAME sPulse_C
#include "simstruc.h"
#include <math.h>
...
static void mdlOutputs(SimStruct *S,int_T tid) //flag 3
{
       ...
       for(l=0;l<599;l++){
           ...
           FirstR1=compute(l-0.3277777777777,60);
           LastR1=compute(l+0.17222222222222,60);
           if(l%2==0){
               FirstR2=compute(l+0.34444444444444,120);
               LastR2=compute(l+1.34444444444444,120);
           }          
