...
#define S_FUNCTION_NAME sPulse_B
#include "simstruc.h"
#include <math.h>
...
static void mdlOutputs(SimStruct *S,int_T tid) //flag 3
{
       ...
       for(l=0;l<599;l++){
           ...
           FirstR1=compute(l-(0.1638888888888888888),60);
           LastR1=compute(l+(0.3361111111111111111),60);
           if(l%2==0){
               FirstR2=compute(l+(0.67222222222222222222),120);
               LastR2=compute(l+(1.67222222222222222222),120);
           }          
